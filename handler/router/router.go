...
func NewRouter(DB *sql.DB) *http.ServeMux {
	...
	h2 := handler.NewGameHandler(*service.NewSelectedCardService(DB), *service.NewRoomService(DB), *service.NewUserService(DB), *service.NewBattleService(DB), *service.NewUserSelectService(DB))
